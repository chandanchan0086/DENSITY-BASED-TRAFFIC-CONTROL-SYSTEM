...
void setup(){
  Serial.begin(9600);
  Timer1.initialize(100);  //Begin using the timer. This function must be called first. "microseconds" is the period of time the timer takes.
...
void softInterr()
{
  ...
  delay(1000);
  Serial.print("S1: ");
  Serial.print(S1);delay(1000);
  Serial.print("  S2: ");
  Serial.print(S2);delay(1000);
  Serial.print("  S3: ");
  Serial.print(S3);delay(1000);
  Serial.print("  S4: ");
  Serial.println(S4);
}
